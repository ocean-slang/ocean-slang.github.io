---
layout: page
title: Estimating eddy-driven particulate organic carbon flux from remote sensing at a dynamic upwelling front
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/poc_sst_maps.png" title="spatial distributions of particulate organic carbon and vertical heat flux" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
